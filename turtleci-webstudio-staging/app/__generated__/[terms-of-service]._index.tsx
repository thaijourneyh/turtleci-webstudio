...
<div
id={"w-node-_7483c5f0-6c73-8915-0900-71e22f1e731b-9a5fff5f"}
...
<p
className={`w-element`}>
{"These Terms of Service govern your use of TurtleCI's subscription-based continuous integration and development platform. By using our services, you agree to comply with these terms and conditions. Please read them carefully before accessing or using our services."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<h4
className={`w-element`}>
{"LEGAL TERMS AND CONDITIONS FOR USING TURTLECI"}
</h4>
<p
className={`w-element`}>
<span
...
<p
className={`w-element`}>
{"By accessing or using any of TurtleCI’s services, you acknowledge and agree to be bound by these Terms of Service in their entirety. These terms constitute a legal agreement between you and TurtleCI, governing your use of our services. If you disagree with any portion of these terms, you should not use our services, as continued use implies acceptance of all terms stated herein. These Terms of Service are effective as of 14/10/2024."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"TurtleCI provides a subscription-based continuous integration and development platform designed to help users efficiently build, test, and deploy applications. Our service integrates with version control systems, processes builds using allocated resources, and provides automation tools to streamline development workflows. The effectiveness of our service depends on proper configuration by users and compliance with applicable guidelines for usage."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"To use the TurtleCI service, you must be at least 18 years of age, or the age of majority in your jurisdiction, whichever is older. By using our service, you confirm that you meet this age requirement and that you are capable of understanding and entering into a legally binding contract in accordance with these terms. You are responsible for ensuring your use of TurtleCI complies with all applicable laws in your jurisdiction."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"To access TurtleCI’s features, you must create an account. You agree to provide accurate, current, and complete information during the registration process and to update this information as necessary. You are responsible for maintaining the confidentiality of your account credentials and any activities that occur under your account, whether or not authorized. TurtleCI is not liable for any losses arising from your failure to safeguard your account information. You agree to notify TurtleCI promptly of any unauthorized use of your account."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"TurtleCI operates as a subscription service, with pricing details available on our Pricing Page. By subscribing, you agree to:"}
</p>
<p
className={`w-element`}>
{" • The subscription fees associated with your plan, billed on a recurring basis."}
</p>
<p
className={`w-element`}>
{" • The cancellation and refund policies specified in our [Cancellation & Refund Policy] page."}
</p>
<p
className={`w-element`}>
{"TurtleCI reserves the right to modify its pricing structure. We will notify you of any changes in advance."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"You are granted a non-exclusive, non-transferable, and revocable license to use TurtleCI’s services for personal or organizational purposes, strictly in compliance with these Terms of Service. You agree not to:"}
</p>
<p
className={`w-element`}>
{" • Use our service for unlawful activities or distribute malicious content."}
</p>
<p
className={`w-element`}>
{" • Attempt to reverse engineer, disassemble, or tamper with TurtleCI’s systems."}
</p>
<p
className={`w-element`}>
{" • Engage in actions that may disrupt, damage, or impair the functionality of our services."}
</p>
<p
className={`w-element`}>
{" • Violate privacy, intellectual property, or other third-party rights."}
</p>
<p
className={`w-element`}>
{"You agree not to use the service in a manner that violates any laws, regulations, or third-party rights."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"Your use of TurtleCI is governed by our Privacy Policy, which details how we collect, use, and protect your personal information. By using our services, you consent to the practices described in the Privacy Policy. Please review it for full details on how your data is handled. Our Privacy Policy is available at TurtleCI Privacy and Policy."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"While TurtleCI employs industry-standard security measures to protect your data, no method of data transmission or storage is completely secure. We encourage users to take additional precautions, such as using secure internet connections and enabling two-factor authentication. TurtleCI disclaims liability for unauthorized access or data breaches despite our security measures. We are committed to complying with applicable data protection laws, including [insert relevant law or jurisdiction], to ensure the security and privacy of your data."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"TurtleCI aims to provide consistent, high-quality service. However, we reserve the right to modify, suspend, or discontinue any aspect of the service at any time, without prior notice. We may also update these Terms of Service periodically. Significant changes will be communicated via email or a prominent notice on our website. Continued use of the service implies acceptance of the updated terms."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"TurtleCI reserves the right to terminate or suspend your access to the service if you breach these terms. In the event of termination, you must cease all use of the service immediately. Subscription fees are non-refundable, and no compensation will be provided for any unused portion of the subscription period if termination results from a violation of these terms."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"All intellectual property rights, including trademarks, logos, content, software, and other proprietary materials provided by TurtleCI, are owned by TurtleCI or its licensors. You are permitted to use these materials solely for your personal or organizational use as specified in your subscription. Reproduction, modification, or redistribution of these materials without prior written consent is prohibited."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"To the maximum extent permitted by applicable law, TurtleCI is not liable for any indirect, incidental, special, consequential, or punitive damages arising out of or related to your use of our services. Our total liability to you for any claims related to the service will not exceed the amount paid by you in the previous subscription cycle. These limitations do not affect your statutory consumer rights."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"You agree to indemnify, defend, and hold harmless TurtleCI, its affiliates, officers, directors, employees, and agents from any claims, damages, liabilities, and expenses (including attorney’s fees) arising out of your violation of these Terms of Service or misuse of the service, including third-party claims."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"These terms are governed by and interpreted in accordance with the laws of New South Wales, Australia. You agree to submit to the exclusive jurisdiction of the courts in Sydney for any disputes."}
</p>
<p
className={`w-element`}>
{"‍"}
...
<p
className={`w-element`}>
{"For questions, concerns, or complaints regarding these Terms of Service or TurtleCI’s services, please contact us at "}
<a
href={"mailto:admin@turtleci.io"}
className={`w-element`}>
{"admin@turtleci.io"}
</a>
