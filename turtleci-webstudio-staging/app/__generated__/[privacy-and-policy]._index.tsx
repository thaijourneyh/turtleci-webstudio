...
<div
className={`w-element c1ro25gr c1m333il cds5ulr c1rfbdao cxsker3 caoid09 c14jek5s ctx8ibw c14iwcl4 c19adc7b c1tbqqby c189uwjb c1vro1vt c93ul7a c5bq8c7 c8arrar cynjjrm cw4w1ux c5fry1g clu1xzz c1kwepi8 ${"global-styles w-embed"}`}>
<HtmlEmbed
code={"<style>body{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-smoothing:antialiased;text-rendering:optimizeLegibility}*[tabindex]:focus-visible,input[type=\"file\"]:focus-visible{outline:0.125rem solid #4d65ff;outline-offset:0.125rem}@media (min-width:1441px){body{font-size:1rem}}.w-richtext>:not(div):first-child,.w-richtext>div:first-child>:first-child{margin-top:0!important}.w-richtext>:last-child,.w-richtext ol li:last-child,.w-richtext ul li:last-child{margin-bottom:0!important}@media screen and (max-width:991px){.pricing_list.column-amount-5 div{grid-column:span 1}.pricing_list.column-amount-5>div:nth-child(5){grid-column:span 2;width:100%;max-width:calc(50%);margin-left:auto;margin-right:auto}.pricing_list.column-amount-3>div:nth-child(3){grid-column:span 2;width:100%;max-width:calc(50%);margin-left:auto;margin-right:auto}.testimonial_grid.column-3>div:nth-child(3){grid-column:span 2;width:100%;max-width:calc(50% - 3.75em);margin-left:auto;margin-right:auto}}@media screen and (max-width:767px){.pricing_list.column-amount-3 div:nth-child(3){grid-column:span 1;max-width:100%}.testimonial_grid.column-3>div:nth-child(3){grid-column:span 1;width:100%}}@media screen and (max-width:479px){.pricing_list.column-amount-5 div{grid-column:span 1;width;100%;}.pricing_list.column-amount-5 div:nth-child(5){grid-column:span 1;max-width:100%}}</style>"}
className={`w-html-embed`} />
</div>
<div
className={`w-element c1chl3ha cfko4c5 cmcjy5s c1ek6cds c16agd5o c14jek5s ctx8ibw c14iwcl4 c19adc7b c1tbqqby c189uwjb c1vro1vt c93ul7a c5bq8c7 c8arrar cynjjrm cw4w1ux c5fry1g clu1xzz c1kwepi8 ${"page-css w-embed"}`} />
<div
...
<div
className={`w-element c1hxqw1p caai4an cmh603w c1nct5tu c17wenqj c170v7gy c13s97cq c1jir8pn c140mlhs cfo0qtk c1i1wffc c1xn1ugd c1d2jaa0 c1xfacko ${"padding-global is-hero style-18"}`}>
<div
className={`w-element c1v0fx6w ctx8ibw c14jek5s c1ro25gr c1kuwk32 c4gouwl caxr30d caqe5xq c1c8uskx cmbbocb c1xn1ugd c1cnynqc c14iwcl4 c19adc7b c1tbqqby c189uwjb c1vro1vt c93ul7a c5bq8c7 c8arrar cynjjrm cw4w1ux c5fry1g clu1xzz c1kwepi8 cm2lply c431rxe c15trozn ${"w-layout-blockcontainer container-lg style-19 w-container"}`}>
<div
...
<div
id={"w-node-_7483c5f0-6c73-8915-0900-71e22f1e731b-2ed8878b"}
...
<h1
className={`w-element c1noxpoj c18ghmj7 ${"text-color-brand style-25"}`}>
{"Privacy Policy"}
</h1>
</div>
</div>
...
<section
className={`w-element c1pxkabf cwqsbw c1vtrtst ${"terms-of-services-section"}`}>
<div
className={`w-element c1hxqw1p caai4an cmh603w c1nct5tu c17wenqj c170v7gy c13s97cq c1jir8pn c140mlhs cfo0qtk c1i1wffc c1xn1ugd c1d2jaa0 c1xfacko ${"padding-global is-hero"}`}>
<div
className={`w-element c1v0fx6w ctx8ibw c14jek5s c1ro25gr c1kuwk32 c4gouwl caxr30d caqe5xq c1c8uskx cmbbocb c1xn1ugd c1cnynqc c14iwcl4 c19adc7b c1tbqqby c189uwjb c1vro1vt c93ul7a c5bq8c7 c8arrar cynjjrm cw4w1ux c5fry1g clu1xzz c1kwepi8 cm2lply c431rxe c15trozn ${"w-layout-blockcontainer container-lg w-container"}`}>
<div
className={`w-element c13dsrcw cvv99b2 cbplqux c1qu1cb1 c110uequ c1gui0mv ctx8ibw c14jek5s cdzvqh6 ${"terms-of-services-content"}`}>
<div
...
<span
className={`w-element`}>
{"At TurtleCI, your privacy is our priority. Here’s a summary of how we collect, use, and protect your data."}
</span>
<br
className={`w-element`} />
<span
className={`w-element`}>
{"In the Privacy Policy section below, you can learn about the information and personal data we collect."}
</span>
<br
className={`w-element`} />
<span
className={`w-element`}>
{"The Cookies section explains how our website uses cookies and similar technologies to enhance your experience."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"In the Terms and Conditions section, you will find the rules governing the services available on our website and platform, including the terms of access and service provision by TurtleCI."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"This website is operated by Journeyhorizon operating at the following address:"}
</span>
<br
className={`w-element`} />
<span
className={`w-element`}>
{"- HCMC, Vietnam: Nguyen Lam Tower, 133 Duong Ba Trac St., Ward 1, Dist. 8, HCMC"}
</span>
<br
className={`w-element`} />
<span
className={`w-element`}>
{"- Canberra, Australia: Level 5, 1 Moore St, Canberra City, ACT, 2601"}
</span>
</blockquote>
<p
className={`w-element`}>
...
<strong
className={`w-element`}>
{"TURTLECI COMMITMENT TO PRIVACY"}
</strong>
</h4>
<p
className={`w-element`}>
...
{"The data controller for TurtleCI is Journeyhorizon. For any privacy-related inquiries, please contact us at: admin@turtleci.io."}
<strong
className={`w-element`}>
{"‍"}
</strong>
...
<span
className={`w-element`}>
{"We collect voluntary data provided by users when they interact with our website or services. Examples of such data include:"}
</span>
<br
className={`w-element`} />
</p>
...
<span
className={`w-element`}>
{"We do not process user data unless the user voluntarily submits it, such as via a contact form, signing up for updates, or interacting with us on social media. If data is submitted, we may process personal information such as first name, last name, email, company name, social media profile, and IP address."}
</span>
<br
className={`w-element`} />
<strong
...
<span
className={`w-element`}>
{"We also collect and process data related to your visit to our website, which includes:"}
</span>
<br
className={`w-element`} />
</p>
...
<li
className={`w-element`}>
{"User behavior on the website (e.g., duration of visit, pages visited)"}
</li>
</ul>
<p
className={`w-element`}>
{"This data is used to improve website functionality and enhance the user experience."}
<strong
className={`w-element`}>
{"‍"}
</strong>
...
<li
className={`w-element`}>
{"To fulfill your requirements for TurtleCI products and services."}
</li>
<li
className={`w-element`}>
{"To contact you to establish or develop a business relationship."}
</li>
<li
className={`w-element`}>
{"To provide feedback on your ideas or suggestions."}
</li>
<li
className={`w-element`}>
{"To inform you about our company, services, and updates."}
</li>
<li
className={`w-element`}>
{"To contact you for marketing purposes, such as surveys, newsletters, or promotional material (with your consent)."}
</li>
<li
className={`w-element`}>
...
<span
className={`w-element`}>
{"This Privacy Policy applies to all personal data processed by TurtleCI, including:"}
</span>
<br
className={`w-element`} />
</p>
...
<span
className={`w-element`}>
{"The policy covers all data subjects whose personal information is collected, processed, or stored in compliance with relevant data protection regulations such as GDPR (General Data Protection Regulation) and other international data protection laws."}
</span>
<strong
className={`w-element`}>
<br
...
{"We do not share your personal data with third parties without your explicit consent. However, if necessary, we may share data for the following purposes:"}
</p>
<ul
role={"list"}
className={`w-element`}>
...
<li
className={`w-element`}>
{"Temporary processing in transit using secure systems, such as Amazon Web Services (AWS), without permanent storage or retention."}
</li>
</ul>
<p
className={`w-element`}>
<span
className={`w-element`}>
{"Data transfer may occur to third-party providers for processing services, but we ensure that these third parties comply with applicable data protection regulations."}
</span>
<br
className={`w-element`} />
<strong
...
{"You can request corrections to any inaccuracies in your personal data."}
</li>
<li
className={`w-element`}>
<strong
...
{"You can request limitations on how your data is processed."}
</li>
<li
className={`w-element`}>
<strong
...
{"You can request your personal data in a portable format, where applicable."}
</li>
</ul>
<p
className={`w-element`}>
<span
className={`w-element`}>
{"To exercise these rights or for any privacy-related inquiries, please contact us at admin@turtleci.io."}
</span>
<br
className={`w-element`} />
<strong
...
{" If you use cookies on your website, it's a good idea to include a section on how cookies are used and how users can manage their cookie preferences."}
</li>
<li
className={`w-element`}>
<strong
...
{" You may want to add a section that specifies how long you retain personal data and under what circumstances it might be deleted."}
</li>
<li
className={`w-element`}>
<strong
...
{" It’s a good practice to describe the security measures in place to protect user data, especially in the context of handling sensitive information."}
</li>
<li
className={`w-element`}>
<strong
...
{" If your website contains links to third-party websites, you should clarify that you are not responsible for their privacy practices."}
</li>
</ol>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"At TurtleCI, we use cookies and similar technologies to enhance the functionality of our website and provide a better user experience. By using our website, you agree to our use of cookies as described in this policy."}
</span>
<br
className={`w-element`} />
<br
...
<span
className={`w-element`}>
{"These cookies are temporary and are stored only for the duration of your visit to the TurtleCI website. They are deleted once you close your browser."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"These cookies are stored on your device for a specific period or until you manually delete them. They help remember your preferences for future visits to our site."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"These cookies are essential for the basic functions of the website, such as enabling you to sign in or navigate the site. Without them, certain features may not be available."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"These cookies provide security features, such as detecting fraud during authentication processes and ensuring that our services remain secure."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"These cookies collect information about how users interact with the website. This data helps us analyze and improve website functionality, user experience, and performance."}
</span>
</p>
<p
className={`w-element`}>
...
<strong
className={`w-element`}>
{"6. Functionality or Preferences Cookies:"}
</strong>
<br
className={`w-element`} />
<span
className={`w-element`}>
{"These cookies remember your settings, such as language, region, font size, and other preferences, to provide a more personalized browsing experience."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"These cookies help us track and analyze user behavior, which allows us to improve our services and understand how users interact with our website."}
</span>
</p>
<p
className={`w-element`}>
...
<span
className={`w-element`}>
{"These cookies are used to display relevant and targeted advertisements to you. They also allow us to measure the effectiveness of our marketing campaigns."}
</span>
<br
className={`w-element`} />
<span
...
<p
className={`w-element`}>
{"In addition to the cookies we use, third-party cookies may be placed on your device by external services. These may come from platforms or services such as social media, analytics tools, or advertising providers. These cookies may track your interactions with our website as well as other websites you visit."}
</p>
<p
className={`w-element`}>
<span
...
<li
className={`w-element`}>
{"Cookies from social media platforms (e.g., Facebook, Twitter, LinkedIn)"}
</li>
<li
className={`w-element`}>
{"Analytics cookies from tools like "}
<strong
className={`w-element`}>
{"Google Analytics"}
</strong>
...
<li
className={`w-element`}>
{"Advertising cookies from platforms such as "}
<strong
className={`w-element`}>
{"Facebook Pixel"}
</strong>
...
<span
className={`w-element`}>
{"You can manage or delete cookies at any time by adjusting your browser settings. Most browsers are set to accept cookies automatically, but you can configure your settings to:"}
</span>
<br
className={`w-element`} />
</p>
...
<li
className={`w-element`}>
{"Prompt you to accept cookies before they are stored"}
</li>
<li
className={`w-element`}>
...
<span
className={`w-element`}>
{"Please note that blocking or deleting cookies may affect your experience on the website and limit the functionality of certain features."}
</span>
<br
className={`w-element`} />
<span
...
<span
className={`w-element`}>
{"We use various analytics tools to help us understand user behavior and improve our website. These tools include:"}
</span>
<br
className={`w-element`} />
</p>
...
{" For tracking website traffic and user interactions."}
</li>
<li
className={`w-element`}>
<strong
...
{" To record user sessions and provide heatmaps for better understanding of user behavior."}
</li>
<li
className={`w-element`}>
<strong
...
{" To measure the success of our Facebook advertising campaigns and track website conversions."}
</li>
</ul>
<p
className={`w-element`}>
<span
className={`w-element`}>
{"These tools help us analyze user interactions and optimize our services to better meet your needs."}
</span>
<br
className={`w-element`} />
<span
...
{"We may update this Cookie Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. Any updates to this policy will be posted on this page, and the date of the most recent revision will be indicated."}
</p>
</div>
</div>
<div
