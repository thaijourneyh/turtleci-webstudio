...
<section
className={`w-element ${"hero-section is-blog"}`}>
<div
className={`w-element ${"padding-global is-hero"}`}>
<div
className={`w-element ${"w-layout-blockcontainer container-lg w-container"}`}>
<div
className={`w-element ${"blog-hero"}`}>
<div
id={"w-node-fdb51a93-9599-cf16-b377-00e91f7aa326-d9a78f22"}
className={`w-element ${"blog-hero-left hide-tablet"}`}>
<a
href={"blogs.html"}
className={`w-element ${"heading-style-h3 text-weight-bold"}`}>
{"Blog >"}
</a>
</div>
<div
id={"w-node-_01b34f74-ef7b-84a3-e436-8cebe109b893-d9a78f22"}
className={`w-element ${"hero-rightbox"}`}>
<div
className={`w-element ${"cta_heading-wrap"}`}>
<h1
className={`w-element ${"text-color-brand heading-style-h2 w-dyn-bind-empty"}`} />
</div>
<div
...
<p
className={`w-element ${"w-dyn-bind-empty"}`} />
<div
...
className={`w-element ${"w-layout-blockcontainer container-lg w-container"}`}>
<div
className={`w-element ${"blog-rich-text"}`}>
<div
className={`w-element ${"text-rich-text w-dyn-bind-empty w-richtext"}`} />
<div
