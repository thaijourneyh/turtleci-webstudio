  ...
  const convertElementToInstance = (
    ...
    for (const attr of node.attrs) {
      ...
      if (
        ...
        // Preserve the original class attribute exactly as authored in the
        // imported HTML so external CSS and runtime scripts can keep targeting
        // the same selectors they relied on in the source export.
